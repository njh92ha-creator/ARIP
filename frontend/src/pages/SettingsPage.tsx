      ...
      <Grid container spacing={4}>
        <Grid size={{ xs: 12, lg: 8 }}><Box component="form" onSubmit={(event) => { event.preventDefault(); void save(); }}>
          <Grid container spacing={2.5}>
            ...
            <Grid size={{ xs: 12, md: 6 }}><Field label="CHAT MODEL"><TextField select value={model} onChange={(event) => setModel(event.target.value)} fullWidth sx={fieldSx}><MenuItem value="gpt-4o-mini">gpt-4o-mini</MenuItem><MenuItem value="gpt-4o">gpt-4o</MenuItem><MenuItem value="gpt-5.6-terra">gpt-5.6-terra</MenuItem><MenuItem value="meta/llama-3.1-70b-instruct">NVIDIA · Llama 3.1 70B</MenuItem><MenuItem value="meta/llama-3.2-3b-instruct">NVIDIA · Llama 3.2 3B</MenuItem></TextField></Field></Grid>
