...
export function RiskReviewDetailPage() {
  ...
  return <Box>
    ...
    <Box sx={{ display: 'grid', gridTemplateColumns: { xs: 'minmax(0, 1fr)', lg: 'minmax(0, 1.65fr) minmax(340px, .9fr)' }, gap: 3, alignItems: 'start', mt: 3, height: { lg: 'calc(100vh - 330px)' }, minHeight: 0 }}>
    <Stack spacing={3} sx={{ minHeight: 0, overflowY: { lg: 'auto' }, overscrollBehavior: { lg: 'contain' }, pr: { lg: 1 } }}>
